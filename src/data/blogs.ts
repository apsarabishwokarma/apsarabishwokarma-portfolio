import { BlogCardProps } from "@/components/navigation/blog/blog-contents/blog-card";

export const blogs: BlogCardProps[] = [
  {
    slug: "javascript-projects",
    img: "/javaScriptprojects.png",
    date: "02/02/2024",
    blogName: "javascript projects",
    blogDetails: "javascript projects(Html,css,Js) ",
    readTime: "10",
  },
  {
