...
They allow you to apply styles to elements based on their state in the document.
...
Pseudo-elements are keywords added to selectors that allow you to style specific parts of an element.
They create a virtual element that does not exist in the document tree.
...
- **Pseudo-classes**:
  - `a:link`, `a:visited`, `a:hover`, `a:active`: Style different states of a link.
- **Pseudo-elements**:
  - `p::first-line`: Styles the first line of a paragraph.
  - `p::first-letter`: Styles the first letter of a paragraph.
  - `p::after`: Inserts content after the paragraph.
