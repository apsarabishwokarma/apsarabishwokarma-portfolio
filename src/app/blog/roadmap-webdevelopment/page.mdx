...
When elements are floated, it can affect the layout of subsequent elements, sometimes causing them to wrap around the floated elements unintentionally. To prevent this, the `clear` property is used to specify which sides of an element should not be allowed to float elements.
...
<h2>CSS Float Property</h2>

<div class="container">
  <div class="box float-left">Float Left</div>
  <div class="box float-right">Float Right</div>
  <div class="text">
    This is some text that will wrap around the floated elements. It will wrap around both the floated elements on the left and right.
  </div>
  <div class="clear-both"></div>
  <div class="text">
    This text is below the cleared floats. It will not wrap around the floated elements.
  </div>
</div>
...
- **`float: none`**: Default value, no floating applied.
- **`clear` property**: Used to control the wrapping of floated elements and ensure proper layout flow.

The `float` property is a powerful tool for positioning elements and controlling text flow, though it's more common now to use Flexbox and Grid for complex layouts.
